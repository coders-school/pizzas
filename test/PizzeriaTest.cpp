...
TEST_F(PizzeriaTest, mainSimulationCase) {
    //Given
    constexpr double strictPizzaPrice = 5.0;
    constexpr double nicePizzaPrice = 10.0;
    constexpr char strictPizzaName[] = "strictPizza";
    constexpr char nicePizzaName[] = "nicePizza";
    constexpr minutes strictPizzaTime{5};
    constexpr minutes nicePizzaTime{2};

...
double Pizzeria::calculatePrice(int orderId)
{
    ...
    if (order != orders_.end())
    {
        ...
        throw std::invalid_argument("Order with id: " + std::to_string(orderId) + " not found (1)");
    }
}
...
void Pizzeria::bakePizzas(int orderId)
{
    ...
    if (order != orders_.end())
    {
        ...
        throw std::invalid_argument("Order with id: " + std::to_string(orderId) + " not found (2)");
    }
}
...
void Pizzeria::completeOrder(int orderId)
{
    ...
    if (order != orders_.end())
    {
        ...
        throw std::invalid_argument("Order with id: " + std::to_string(orderId) + " not found (3)");
    }
}

...
double Pizzeria::calculatePrice(int orderId)
{
    ...
    throw std::invalid_argument("calculatePrice Order with id: " + std::to_string(orderId) + "not found");
}
...
void Pizzeria::bakePizzas(int orderId)
{
    ...
    throw std::invalid_argument("bakePizzas Order with id: " + std::to_string(orderId) + "not found");
}
...
void Pizzeria::completeOrder(int orderId)
{
    ...
    throw std::invalid_argument("completeOrder Order with id: " + std::to_string(orderId) + "not found");
}
